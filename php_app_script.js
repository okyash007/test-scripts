      ...
      if (addResponse != "" || addResponse == null) {
        ...
        if (tbSettings.placement_type == 0) {
          if (tbSettings.position == 1) {
            $tbjobject(".step__sections").prepend(
              '<div class="tb-inline-wrapper"></div>'
            );
          } else {
            $tbjobject(".step__sections").append(
              '<div class="tb-inline-wrapper"></div>'
            );
          }
          ...
          var tbModalHtml =
            '<div class="tailboost-modal-wrapper" id="tailboost-modal-wrapper">' +
            ...
            "</div>";
          $tbjobject(".step__sections").prepend(
            '<div class="tb-model-wrapper"></div>'
          );
